  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h2 className={`text-xl md:text-2xl font-light mb-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            Showcasing my journey of passion, growth and creation during my Brentwood years
          </h2>
          ...
          <div className={`flex justify-center gap-4 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Button 
              ...
              onClick={() => window.open('https://drive.google.com/file/d/1e9o2pwRG84rN9bg69UHiOgJpcPiJ_YoH/view?usp=sharing', '_blank')}
            >
