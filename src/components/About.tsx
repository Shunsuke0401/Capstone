          ...
          <div className="grid md:grid-cols-2 gap-10 items-center mb-16">
            ...
            <div className="animate-slide-in-right">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                I'm a passionate individual dedicated to continuous growth and learning. 
                With a background in [your background], I've developed a unique perspective 
                that allows me to approach challenges creatively and effectively.
              </p>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                My journey has been shaped by curiosity and a drive to create meaningful work 
                that makes a difference. I believe in the power of [your belief or philosophy] 
                and strive to embody this in everything I do.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                When I'm not [working/learning], you can find me [your hobbies or interests].
              </p>
            </div>
          </div>
